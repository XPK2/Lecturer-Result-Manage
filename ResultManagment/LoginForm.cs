...
namespace ResultManagement
{
    public partial class LoginForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try 
            {
                SqlDataAdapter sqlDataAdapter = new SqlDataAdapter("SELECT * FROM Login_new WHERE userName LIKE'"+textun.Text+"' AND password LIKE'"+textpw.Text+"'",MyDb.getConnection);
